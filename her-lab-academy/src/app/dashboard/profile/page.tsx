...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <div className="max-w-2xl mx-auto pb-12 text-center py-20 text-gray-500">
        Loading profile...
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto pb-12 space-y-8">
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6 flex items-center gap-6">
        <AvatarFallback name={fullName || 'Student'} size="lg" />
        <div>
      ...
      >
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="flex items-center gap-2 bg-[var(--color-primary)] text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-[#cf5626] transition-colors"
          >
            {saved ? (
              <>
      ...
      >
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="flex items-center gap-2 border border-gray-300 text-gray-700 px-5 py-2 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors"
          >
            {pwSaved ? (
              <>
